  ...
  return (
    <SafeAreaView style={styles.container}>
      <MapView
        ...
        initialRegion={{// setCoords({ latitude: 6.262293, longitude: -75.598558 });
          latitude: 6.262293,
          longitude: -75.598558,
      ...
      >
        ...
        <View style={styles.bottomSheet}>
          {selectedTechnician && (
            <>
              <Image source={{ uri: selectedTechnician.photo }} style={styles.photo} />
              <Text style={styles.name}>
                {selectedTechnician.firstName} {selectedTechnician.lastName}
              </Text>
              <Text style={styles.company}>{selectedTechnician.company.name}</Text>
              <Text style={styles.rating}>
                {selectedTechnician.rating} <AntDesign name="star" size={16} color="#f5d442" />
              </Text>
            </>
          )}
        </View>
